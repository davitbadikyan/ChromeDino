...
export class ScreenUtils {
	...
	ScreenMetrics {
		...
		// The BLUE is the extra area that will be visible on devices with a 16:9 aspect ratio (iPhone 5 and above) (this is probably the
		// most common ratio overall...)
		// The GREY area will most likely never be seen, unless some device has a really odd aspect ratio (and with Android, I wouldn't be
		// surprised if there is a few out there)
		...
		// Calculate the max width and max height if not provided; ratios are based off iPad (4:3) and iPhone 5+ (16:9)
		// as the extremes in both width and height
